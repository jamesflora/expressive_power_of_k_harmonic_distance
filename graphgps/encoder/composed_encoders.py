...
from graphgps.encoder.rpe_transformer_encoder import RPEMpnnEncoder
...
register_node_encoder(
        f"Atom+RPEMpnn",
        concat_node_encoders([AtomEncoder, RPEMpnnEncoder],
                             ["RPE"])
    )

register_node_encoder(
        f"LinearNode+RPEMpnn",
        concat_node_encoders([LinearNodeEncoder, RPEMpnnEncoder],
                             ["RPE"])
    )

register_node_encoder(
        f"TypeDictNode+RPEMpnn",
        concat_node_encoders([TypeDictNodeEncoder, RPEMpnnEncoder],
                             ["RPE"])
    )
